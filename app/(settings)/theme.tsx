  ...
  return (
    <>
      ...
      >
        ...
        {/* Dark */}
        <Pressable className="my-3 flex-row items-center justify-around gap-5 rounded-2xl border-2 border-[#1d1f25] bg-[#3b3f4f] p-5">
        ...
        {/* Light */}
        <Pressable className="my-3 flex-row items-center justify-around rounded-2xl border-2 border-green-400 bg-[#86aaa7] p-5">
        ...
        {/* Auto */}
        <Pressable className="my-3 flex-row items-center justify-around rounded-2xl border-2 border-gray-600 bg-gray-50 p-5">
